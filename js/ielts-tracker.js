(function () {
  ...
  function createMarkup() {
    return [
      ...
      '  </div>',
      '  <div class="ielts-panel ielts-calendar-panel"><div class="ielts-panel-heading"><div><span>DAILY PRACTICE</span><h3>学习日历</h3></div><div class="ielts-calendar-selectors"><label>年份 <select class="ielts-year" aria-label="日历年份"></select></label><label>月份 <select class="ielts-month-select ielts-year" aria-label="日历月份"></select></label></div></div><p data-calendar-summary></p><div class="ielts-calendar-scroll"><div class="ielts-calendar" data-calendar></div></div><div class="ielts-heat-legend" aria-label="学习时长颜色：从未记录到大于等于120分钟"><span>未记录</span><i class="ielts-heat-gradient"></i><span>≥120 分钟</span></div><div class="ielts-day-detail" data-day-detail hidden></div></div>',
